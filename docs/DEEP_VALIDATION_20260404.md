...
**Generated | 生成时间**: 2026-04-04T07:23:27.307828
**Version | 版本**: 5.3.4
**Validation Type | 验证类型**: Deep (10 iterations) | 深度 (10 次迭代)
**Overall Status | 总体状态**: ✅ PASSED
...
| Metric | 指标 | Value | 值 |
|--------|------|-------|-----|
| Average Validation Score | 平均验证分数 | 1.0000 | |
| Formulas with Score ≥ 0.9 | 分数≥0.9 的公式 | 8/8 | |
...
**Timestamp | 时间戳**: 2026-04-04 07:23:27 (Asia/Shanghai)
